...
public class setOmrVaPasandaz {

    public void connect(final Context context, final String mablagh, final String NameBimehGozar, final String NameBimehShode, final String ShenaseBimeName, final String MablaghGharardad, final String RaveshPardakht) {
