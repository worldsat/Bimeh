...
public class getLoadGetForoshGozashteh {
    ...
    public void get_banners(final Context context, final ProgressBar ProgressBar, final RecyclerView recyclerViewlist, final TextView warning, final String Activity) {
