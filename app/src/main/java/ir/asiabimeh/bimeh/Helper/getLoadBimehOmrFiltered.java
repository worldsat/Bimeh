...
public class getLoadBimehOmrFiltered {
    ...
    public void get_banners(final Context context, final ProgressBar ProgressBar, final RecyclerView recyclerViewlist, final String Activity, final String From, final String to) {
