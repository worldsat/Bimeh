...
public class PadashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_padash);
        ...
        getLoadPadash getLoadPadash = new getLoadPadash();
        getLoadPadash.get_banners(this, progressBar, recyclerView);
    ...
    private void Toolbar() {
        ...
        titleActionBar.setText("وضعیت پاداش");
    ...
    private void backMethod() {
        Intent intent = new Intent(PadashActivity.this, FinanceListActivity.class);
